	...
	$.wysiwyg.controls.link = {
		init: function (Wysiwyg) {
			...
			formLinkHtml = '<form class="wysiwyg"><fieldset><legend>{legend}</legend>' +
				'<label>{url}: <br><input type="text" name="linkhref" value="" style="width:260px"/></label><br>' +
				'<label>{title}: <br><input type="text" name="linktitle" value="" style="width:260px"/></label><br>' +
				'<label>{target}: <br><input type="text" name="linktarget" value="" style="width:260px"/></label><br>' +
